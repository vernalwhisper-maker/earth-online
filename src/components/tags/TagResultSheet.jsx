...
export default function TagResultSheet({ isOpen, mode, status, totalCount, tags, removedTag, aiMode, onClose }) {
  ...
  return (
    <GlassModal show={isOpen} onClose={onClose} variant="bottom" contentClassName="p-4">
      {/* Header */}
      <div className="flex items-center justify-between mb-2">
        ...
        <button onClick={onClose} className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors">
