...
> **v1.6.0** 全面升级设计语言（极简配色 / 列表式卡片 / 统一弹窗规范）、AI 升级 DeepSeek V4 Flash 正式版（支持深度思考开关）、导出直写系统 Download（免系统安全访问）。
>
...
- **极简质感** —— 浅色白底 / 深色 `#17212b`、accent `#3390ec`，列表式笔记卡片（渐变头像 / 时间戳 / 右下角标签）、统一磨砂弹窗与实色面板规范。
