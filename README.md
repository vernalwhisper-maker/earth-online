...
- **AI Assistant** -- Built-in chat panel that can analyze your notes, generate summaries, and execute actions (move between folders, add/remove tags, change note type, pin/delete). Supports DeepSeek, Zhipu, and Qwen providers.
