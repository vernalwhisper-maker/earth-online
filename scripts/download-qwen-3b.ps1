# Download Qwen2.5-3B-Instruct-q4f16_1-MLC (WebLLM model) from hf-mirror.com
# Usage: in PowerShell, run:  powershell -ExecutionPolicy Bypass -File download-qwen-3b.ps1
# All files will be saved to the CURRENT directory.

$ErrorActionPreference = "Stop"
$base = "https://hf-mirror.com/mlc-ai/Qwen2.5-3B-Instruct-q4f16_1-MLC/resolve/main/"
...
for ($i = 0; $i -le 61; $i++) { $files += "params_shard_$i.bin" }
